...
def main():
    ...
    for file_path in list_pdf:
        print("Начинаем парсить один из файлов:", file_path)
        ...
        list_chunks = []
        print("Начинаем добавлять чанки в список:")
        for chunk in chunks_dict:
            list_chunks.append(chunk["text"])
        print("Начинаем векторизовать чанки:")
        embeddings = embedder.embed_text(list_chunks)
        print("Закончили векторизацию, создаем коллекцию и загружаем в коллекцию")
